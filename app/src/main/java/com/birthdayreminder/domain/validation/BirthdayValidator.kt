 ...
 */
@Singleton
class BirthdayValidator @Inject constructor() {
    ...
    companion object {
        ...
        const val ERROR_INVALID_NOTIFICATION_HOUR = "Notification hour must be between $MIN_NOTIFICATION_HOUR and $MAX_NOTIFICATION_HOUR"
        const val ERROR_INVALID_NOTIFICATION_MINUTE = "Notification minute must be between $MIN_NOTIFICATION_MINUTE and $MAX_NOTIFICATION_MINUTE"
    }
