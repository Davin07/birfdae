...
class ScheduleNotificationUseCase
    ...
    constructor(
        ...
        private fun scheduleBirthdayNotification(birthday: Birthday) {
            ...
            if (delay > 0) {
                val workRequest =
                    OneTimeWorkRequestBuilder<BirthdayNotificationWorker>()
                        .setInitialDelay(delay, TimeUnit.MILLISECONDS)
                        .setInputData(
                            Data.Builder()
                                .putLong(BirthdayNotificationWorker.BIRTHDAY_ID_KEY, birthday.id)
                                .putString(
                                    BirthdayNotificationWorker.NOTIFICATION_TYPE_KEY,
                                    BirthdayNotificationWorker.TYPE_BIRTHDAY_TODAY,
                                )
                                .build(),
                        )
                    ...
                    OneTimeWorkRequestBuilder<BirthdayNotificationWorker>()
                        ...
                        .setInputData(
                            Data.Builder()
                                ...
                                .putString(
                                    BirthdayNotificationWorker.NOTIFICATION_TYPE_KEY,
                                    BirthdayNotificationWorker.TYPE_ADVANCE_REMINDER,
                                )
