...
class BackupManager @Inject constructor(
     ...
     */
    suspend fun exportBirthdays(uri: Uri): Result<Unit> = withContext(Dispatchers.IO) {
     ...
     */
    suspend fun importBirthdays(uri: Uri, conflictStrategy: ConflictStrategy): Result<Int> = withContext(Dispatchers.IO) {
        return@withContext try {
            // Read from file
