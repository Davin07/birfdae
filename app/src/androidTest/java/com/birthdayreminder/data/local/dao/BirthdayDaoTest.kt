...
class BirthdayDaoTest {
    ...
    @Test
    fun insertBirthday_insertsAndReturnsId() = runTest {
        // Given
    ...
    @Test
    fun getAllBirthdays_returnsAllInsertedBirthdays() = runTest {
        // Given
    ...
    @Test
    fun searchBirthdaysByName_isCaseInsensitive() = runTest {
        // Given
        birthdayDao.insertBirthday(createTestBirthday("alice johnson", LocalDate.of(1985, 3, 10)))
        birthdayDao.insertBirthday(createTestBirthday("ALICE BROWN", LocalDate.of(1988, 12, 5)))
        birthdayDao.insertBirthday(createTestBirthday("Bob Smith", LocalDate.of(1992, 8, 20)))
    ...
    fun getBirthdaysWithNotificationsEnabled_returnsOnlyEnabledBirthdays() = runTest {
        // Given
        birthdayDao.insertBirthday(createTestBirthday("Enabled 1", LocalDate.of(1990, 1, 1), notificationsEnabled = true))
        birthdayDao.insertBirthday(createTestBirthday("Disabled 1", LocalDate.of(1990, 2, 2), notificationsEnabled = false))
        birthdayDao.insertBirthday(createTestBirthday("Enabled 2", LocalDate.of(1990, 3, 3), notificationsEnabled = true))
        birthdayDao.insertBirthday(createTestBirthday("Disabled 2", LocalDate.of(1990, 4, 4), notificationsEnabled = false))
    ...
    @Test
    fun flowUpdates_emitNewValuesOnDataChange() = runTest {
        // Given
